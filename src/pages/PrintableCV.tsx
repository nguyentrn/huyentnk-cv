...
export const PrintableCV = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <div
      ref={ref}
      className={
        "prose bg-white prose-printable prose-neutral relative mx-auto grid h-[396mm] w-[280mm] max-w-none grid-cols-[1fr_2.2fr] grid-rows-[1fr_6fr] gap-x-12 p-10 pt-12 pr-12 shadow-lg"
      }
    >
      <div
        className={
