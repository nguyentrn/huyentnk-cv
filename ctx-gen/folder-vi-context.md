...
```json
{
  ...
  "home": {
    ...
    "headline": "Sẵn sàng học hỏi và đóng góp cho các chiến dịch marketing hiệu quả.",
    "subheading": "Mỗi thương hiệu đều có một câu chuyện riêng. Mình ở đây để lắng nghe, tìm kiếm những điều đặc biệt và mong muốn giúp câu chuyện đó được tỏa sáng.",
